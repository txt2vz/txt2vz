...
(function (global, factory) {
    ...
    d3.chart("hierarchy").extend("cluster-tree", {
        ...
        transform: function (nodes) {
            ...
            if (!chart._internalUpdate) {
                chart.trigger("init:collapsible", nodes);
            }
            ...
            if (chart.options.levelGap && chart.options.levelGap !== "auto") {
                nodes.forEach(function (d) {
                    d.y = d.depth * chart.options.levelGap;
                });
            }
    ...
    d3.chart("cluster-tree").extend("cluster-tree.cartesian", {
        ...
        initialize: function () {
            ...
            chart.d3.diagonal = d3.svg.diagonal().projection(function (d) {
                return [d.y, d.x];
            });
            ...
            chart.layers.nodes.on("enter", function () {
                this
                    .attr("transform", function (d) {
                        return "translate(" + chart.source.y0 + "," + chart.source.x0 + ")";
                    });
            ...
            chart.layers.nodes.on("exit:transition", function () {
                this
                    .attr("transform", function (d) {
                        return "translate(" + chart.source.y + "," + chart.source.x + ")";
                    });
            });
    ...
    d3.chart("cluster-tree").extend("cluster-tree.radial", {
        ...
        initialize: function () {
            ...
            chart.d3.diagonal = d3.svg.diagonal.radial().projection(function (d) {
            ...
            chart.layers.nodes.on("enter", function () {
                this
                    .attr("transform", function (d) {
                        return "rotate(" + (chart.source.x0 - 90) + ")translate(" + chart.source.y0 + ")";
                    });
            ...
            chart.layers.nodes.on("exit:transition", function () {
                this
                    .attr("transform", function (d) {
                        return "rotate(" + (chart.source.x - 90) + ")translate(" + chart.source.y + ")";
                    });
            });
        },
    ...
    d3.chart("hierarchy").extend("pack.flattened", {
        ...
        initialize: function () {
            ...
            chart.layer("base", chart.layers.base, {
                ...
                dataBind: function (nodes) {
                    return this.selectAll(".pack").data(nodes.filter(function (d) {
                        return !d.children;
                    }));
                },
                    ...
                    "enter": function () {
                        ...
                        this.append("circle")
                            ...
                            .style("fill", function (d) {
                                return chart.d3.colorScale(chart.options.bubble.pack(d));
                            });

                        this.append("text")
                            .attr("dy", ".3em")
                            .text(function (d) {
                                return d[chart.options.name].substring(0, d.r / 3);
                            });
    ...
    d3.chart("hierarchy").extend("pack.nested", {
            ...
            chart.layer("base", chart.layers.base, {
                ...
                events: {
                    "enter": function () {
                        ...
                        this.on("click", function (event) {
                            chart.trigger("click:pack", event);
                        });
                    },
        ...
        collapsible: function () {
            ...
            chart.layers.base.on("merge", function () {
                pack = chart.root;
                chart.off("click:pack").on("click:pack", function (d) {
                    collapse(pack == d ? chart.root : d);
                });
            });
    ...
    d3.chart("hierarchy").extend("partition.arc", {
        ...
        initialize: function () {
            ...
            chart.d3.arc = d3.svg.arc()
                .startAngle(function (d) {
                    return Math.max(0, Math.min(2 * Math.PI, chart.d3.x(d.x)));
                })
                .endAngle(function (d) {
                    return Math.max(0, Math.min(2 * Math.PI, chart.d3.x(d.x + d.dx)));
                })
                .innerRadius(function (d) {
                    return Math.max(0, chart.d3.y(d.y));
                })
                .outerRadius(function (d) {
                    return Math.max(0, chart.d3.y(d.y + d.dy));
                });
                ...
                events: {
                    "enter": function () {
                        ...
                        this.attr("d", chart.d3.arc)
                            .style("fill", function (d) {
                                return chart.d3.colorScale((d.children ? d : d.parent)[chart.options.name]);
                            });

                        this.on("click", function (event) {
                            chart.trigger("click:path", event);
                        });
                    }
                }
            });
        ...
        collapsible: function () {
            ...
            function arcTween(d) {
                ...
                return function (d, i) {
                    return i ? function (t) {
                            return chart.d3.arc(d);
                        }
                        : function (t) {
                            chart.d3.x.domain(xd(t));
                            chart.d3.y.domain(yd(t)).range(yr(t));
                            return chart.d3.arc(d);
                        };
                };
            }
    ...
    d3.chart("hierarchy").extend("partition.rectangle", {
        ...
        initialize: function () {
            ...
            chart.d3.transform = function (d, ky) {
            ...
            chart.layer("base", chart.layers.base, {
                ...
                events: {
                    "enter": function () {
                        ...
                        this.append("text")
                            .attr("transform", function (d) {
                                return chart.d3.transform(d, ky);
                            })
                            .attr("dy", ".35em")
                            .style("opacity", function (d) {
                        ...
                        this.on("click", function (event) {
                            chart.trigger("click:rect", event);
                        });
                    }
                }
            });
    ...
    d3.chart("hierarchy").extend("treemap", {
                    ...
                    "enter": function () {
                        ...
                        this.append("rect")
                            ...
                            .attr("fill", function (d) {
                                return d.parent ? chart.d3.colorScale(d.parent[chart.options.name]) : null;
                            });
                        ...
                        this.append("text")
                            ...
                            .attr("dy", ".35em")
                            .text(function (d) {
                                return d.children ? null : d[chart.options.name];
        ...
        collapsible: function () {
            ...
            chart.layers.base.on("merge", function () {
                node = chart.root;
                chart.off("click:rect").on("click:rect", function (d) {
                    collapse(node == d.parent ? chart.root : d.parent);
                });
            });
